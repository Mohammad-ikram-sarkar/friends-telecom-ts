...
import { Sparkles, Mail, Lock, User, ArrowRight, Eye, EyeOff, Axis3D } from "lucide-react";
...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const password = formData.get("enterpassword");
      ...
      <div className="w-full max-w-md sm:max-w-lg lg:max-w-xl space-y-8">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-200 shadow-xl space-y-6">
          ...
          <div className="relative">
            <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 w-4 h-4 sm:w-5 sm:h-5" />
            <input
              type="text"
              name="name"
